...
## Funktionen
- Berechnung des Salzgehalts anhand der vorgesehenen Portionsmenge
- Verwaltung einer Liste von Einträgen (Hinzufügen, Aktualisieren, Löschen)
- Export und Import der Daten als CSV-Datei (lokal, keine Cloud)
- Bedienung auf PC und Mobilgerät möglich

## Nutzung
1. Öffne die Datei `salzrechner.html` im Browser (Doppelklick oder "Im Browser öffnen")
2. Gib die gewünschten Werte ein und nutze die Buttons für Berechnung und Verwaltung
3. Speichere deine Daten als CSV-Datei oder lade sie später wieder ein
